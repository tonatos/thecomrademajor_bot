    ...
    async def generate_response(self, user_message: str) -> str:
        ...
        try:
            ...
            system_prompt = (
                ...
                "Сформулируй небольшой и в меру экспрессивный угрожающий ответ (в "
                "пределах в диапазоне от 250 до 350 символов). Не злоупотребляй "
                "восклицательными знаками. Не предлагай задуматься. Добавь что-нибудь "
                "параноидальное, про слежку, прослушку, сбор улик."
            )
